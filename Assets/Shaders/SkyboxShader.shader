	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 uv_Texture0 = i.ase_texcoord2.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				...
				finalColor = ( ( pow( temp_output_8_0 , _blend ) * lerpResult63 ) + ( pow( temp_output_16_0 , 0.8 ) * lerpResult71 * tex2D( _Texture0, uv_Texture0 ) ) + ( _LandColor * temp_output_10_0 ) + ifLocalVar59 );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18800
0;45;1440;754;-586.0511;-149.1578;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-276.7187,1080.001;Inherit;False;Property;_midblend;mid blend;10;0;Create;True;0;0;0;False;0;False;1.432217;0.8;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;77;1208.051,658.1578;Inherit;True;Property;_Texture0;Texture 0;11;0;Create;True;0;0;0;False;0;False;None;a6ca564f72ee34ab085dbf8f03022c6b;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;70;-32.89622,891.7784;Inherit;False;Property;_MidColor2;Mid Color 2;7;0;Create;True;0;0;0;False;0;False;0.5425863,0.7506646,0.8396226,0;0.9414878,0.6367924,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;18;321.334,747.0739;Inherit;False;Property;_MidColor;Mid Color;2;0;Create;True;0;0;0;False;0;False;0.07471521,0.4779798,0.6886792,0;0.04903872,0.1958795,0.5471698,0.8862745;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;15;-18.21,610.4677;Inherit;False;Property;_LandColor;Land Color;1;0;Create;True;0;0;0;False;0;False;0.389596,0.8018868,0.442467,0;0.08210207,0.3390019,0.3867924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;76;1187.27,506.8381;Inherit;True;Property;_TextureSample1;Texture Sample 1;11;0;Create;True;0;0;0;False;0;False;-1;91f2eef97ddef4826b5944ff4baa8ef5;a6ca564f72ee34ab085dbf8f03022c6b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7BDDB2B0DE6729491E811A99A29F0D6C6C07B9AE