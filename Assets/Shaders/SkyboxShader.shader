	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float simplePerlin2D55 = snoise( temp_output_38_0.xy*3.0 );
				simplePerlin2D55 = simplePerlin2D55*0.5 + 0.5;
				float temp_output_10_0 = ( min( normalizeResult6.y , 0.0 ) * -1.0 );
				
				
				finalColor = ( ( pow( temp_output_8_0 , 1.0 ) * _SkyColor * ( simplePerlin2D55 * max( normalizeResult6.y , 0.0 ) ) ) + ( ( 1.0 - ( temp_output_8_0 + temp_output_10_0 ) ) * _MidColor ) + ( temp_output_10_0 * _LandColor ) );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18800
0;46;1440;754;693.0232;758.4805;1.625716;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-616.0735,-397.0399;Inherit;False;Property;_speed;speed;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;55;417.5081,-568.356;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;15;263.5557,626.6346;Inherit;False;Property;_LandColor;Land Color;1;0;Create;True;0;0;0;False;0;False;0.389596,0.8018868,0.442467,0;0.3895959,0.8018868,0.4424669,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;18;691.9034,-51.28372;Inherit;False;Property;_MidColor;Mid Color;2;1;[HDR];Create;True;0;0;0;False;0;False;0.07471521,0.4779798,0.6886792,0;0.07471516,0.4779797,0.6886792,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;353.8158,-179.2212;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;970.1236,142.8314;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FA63817752680B30055E4C8E382BB727F60E63EC