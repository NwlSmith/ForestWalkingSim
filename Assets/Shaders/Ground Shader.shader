...
Shader "Ground Shader"
{
	Properties
	{
		...
		[ASEEnd]_Lightintensity("Light intensity", Range( 0 , 1)) = 0
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 Albedo74 = _Tint;
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float dotResult51 = dot( ase_worldNormal , _MainLightPosition.xyz );
				...
				float3 Color = ( Shadow64 + RIM105 + Light86 + localClipHoles100_g1 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18800
0;45;1440;754;602.873;-333.5432;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;76;-277.0605,-1278.042;Inherit;False;Property;_Tint;Tint;27;0;Create;True;0;0;0;False;0;False;0.6707013,0.8724177,0.9056604,0;0.490566,0.3892132,0.3216447,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-1486.432,551.1636;Inherit;False;Property;_RIM;RIM;26;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;185;133.8101,93.47831;Inherit;False;Property;_Lightintensity;Light intensity;28;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;102;-1008.346,971.9717;Inherit;False;Property;_RIMTint;RIM Tint;25;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9056604,0.8215459,0.0299039,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;186;-166.6472,706.1758;Inherit;True;Four Splats First Pass Terrain;1;;1;37452fdfb732e1443b7e39720d05b708;2,85,0,102,1;7;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;201;FLOAT;0;False;62;FLOAT;0;False;7;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;19;FLOAT3;17
...
Node;AmplifyShaderEditor.SimpleAddOpNode;112;182.7556,433.4496;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;1;COLOR;0
...
WireConnection;197;2;112;0
ASEEND*/
//CHKSM=D590C0CB1736D76A51C89A6CDACF68B683FF4D82